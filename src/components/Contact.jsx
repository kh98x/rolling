...
const Contact = () => {
  return (
    <div className="pad-top">
      ...
      >
        ...
        <div className="card-img-overlay">
          ...
          <div className="d-flex align-items-end flex-column bd-highlight m-4 p-3">
            <h2 className="card-title letter-space">
              Check out our
            ...
            <h4 className="card-text letter-space p-3 m-3">
              Share your photos and drop a comment!
            </h4>
            <h4 className="card-text letter-space p-3 m-3">
              No gram? No problem
            </h4>
            <h2 className="letter-space p-3 m-3">
              We also have
              <a
      ...
      <div className="contact bg-danger text-white">
        <div id="contact">
        ...
        <div>
          <a href="https://www.instagram.com/wok.rolling/" target="blank">
            <i className="contact-item fab fa-instagram text-white" size="3x" />
          </a>
          <a
            href="https://www.yelp.com/biz/rolling-wok-rowland-heights"
            target="blank"
          ...
          <a href="mailto:wok.rolling@gmail.com" target="blank">
            <i className="contact-item fas fa-envelope text-white" size="3x" />
          </a>
        </div>
      </div>
    </div>
